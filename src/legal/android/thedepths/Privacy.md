...
Link to the privacy policy of the third-party service used for purchases:
...
We do not employ third-party companies or individuals to process data on our behalf, because the app produces no data to process. The only third party involved in the app is Google, which distributes it and processes any purchase you choose to make.
